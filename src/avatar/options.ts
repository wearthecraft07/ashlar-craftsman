...
export const AVATAR_OPTIONS = {
  ...
  clothing: [
    { id: "tee", label: "Lodge Tee" },
    { id: "hoodie", label: "Hoodie" },
    { id: "jacket", label: "Jacket" },
    { id: "polo", label: "Polo" },
    { id: "lodge", label: "Lodge Shirt" },
  ],
  clothingColor: [
    { id: "black", label: "Black", tone: "#151515", shade: "#050505" },
    { id: "white", label: "White", tone: "#F4F1EA", shade: "#D9D3C6" },
    { id: "charcoal", label: "Charcoal", tone: "#2F2F2F", shade: "#1A1A1A" },
    { id: "gold", label: "Gold", tone: "#C9A227", shade: "#9A7A14" },
    { id: "ink", label: "Ink Navy", tone: "#1A2233", shade: "#0D121C" },
    { id: "navy", label: "Lodge Navy", tone: "#1E3A5F", shade: "#12243C" },
  ],
  shoes: [
...
export const AVATAR_CATEGORIES: {
  ...
  { key: "clothingColor", label: "Fit Color" },
